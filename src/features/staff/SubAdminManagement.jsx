    ...
    return (
        <div className='flex flex-col gap-8'>
            <div className='flex justify-between items-center gap-4'>
                ...
                <div onClick={() => setAddSubAdminClicked(!addSubAdminClicked)}>
                    <AddButton icon="material-symbols-light:person-add" content="Sub Admin" to="/sub-admins/add" />
                </div>
            </div>
            {/* {addSubAdminClicked &&
            ...
            <div className='bg-white px-2 py-4 sm:px-4 rounded-md'>
                <div className="flex justify-between mb-4">
                    <h1 className='text-xl font-semibold text-(--primary) py-2'>Sub Admin List</h1>
                    {/* <div className="flex items-center justify-end md:col-span-2 mt-2">
                        {!addSubAdminClicked && (
                            <div onClick={() => setAddSubAdminClicked(!addSubAdminClicked)}>
                                <AddButton icon="material-symbols-light:person-add" content="Sub Admin" to="/sub-admins/add" />
